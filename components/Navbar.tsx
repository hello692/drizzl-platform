      ...
      <nav className="glass" style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1, display: 'flex', justifyContent: 'flex-start', minWidth: 0 }}>
            <Link href="/" style={{ textDecoration: 'none', whiteSpace: 'nowrap', transition: 'all 1s cubic-bezier(0.32, 0, 0.67, 0)', color: '#000', display: 'flex', flexDirection: 'column', gap: '2px', lineHeight: '1' }}>
