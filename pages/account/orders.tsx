...
const mockOrders: Order[] = [
  { 
    ...
    date: 'Dec 8, 2025', 
    items: [
      { name: 'Strawberry Peach Smoothie', quantity: 2, price: 29.99, image: '/products/strawberry-peach/Strawbery peach-TG-1.webp' },
      { name: 'Mango Jackfruit Blend', quantity: 1, price: 29.99, image: '/products/mango-jackfruit/Mango Jackfruit-1.webp' },
    ],
    total: 89.97, 
    status: 'Delivered',
  ...
  { 
    ...
    date: 'Dec 3, 2025', 
    items: [
      { name: 'Coffee Mushroom Blend', quantity: 3, price: 14.99, image: '/products/coffee-mushroom/Coffee Mushroom-1.webp' },
    ],
    total: 44.97, 
    status: 'Shipped',
  ...
  { 
    ...
    date: 'Nov 28, 2025', 
    items: [
      { name: 'Açai Berry Bowl Mix', quantity: 4, price: 14.99, image: '/products/acai/Acai-1.webp' },
    ],
    total: 59.96, 
    status: 'Delivered',
  ...
  { 
    ...
    date: 'Nov 20, 2025', 
    items: [
      { name: 'Matcha Green Smoothie', quantity: 2, price: 14.99, image: '/products/matcha/Matcha-1.webp' },
      { name: 'Chocolate Berry Blend', quantity: 2, price: 14.99, image: '/products/chocolate-berry/Chocolate Berry-1.webp' },
    ],
    total: 59.96, 
    status: 'Delivered',
  ...
  { 
    ...
    date: 'Nov 15, 2025', 
    items: [
      { name: 'Almond Butter Smoothie', quantity: 6, price: 14.99, image: '/products/almond/Almond-1.webp' },
    ],
    total: 89.94, 
    status: 'Delivered',
          ...
          if (dbOrders && dbOrders.length > 0) {
            const formattedOrders: Order[] = dbOrders.map(order => ({
              ...
              items: (order.items as any[])?.map((item: any) => ({
                ...
                image: item.image || '/products/acai/Acai-1.webp',
              })) || [{ name: 'Product', quantity: 1, price: 14.99, image: '/products/acai/Acai-1.webp' }],
