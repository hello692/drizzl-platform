...
const pointsHistory: PointsActivity[] = [
...
export default function CustomerRewards() {
  ...
  const currentTier = tiers.reduce((acc, tier) => 
    lifetimePoints >= tier.minPoints ? tier : acc
  , tiers[0]);
      ...
      <div style={styles.page}>
        ...
        <div style={styles.pointsCard}>
          ...
          <div style={styles.tierSection}>
            <div style={styles.tierBadge} style={{ backgroundColor: `${currentTier.color}20`, color: currentTier.color }}>
              <Trophy size={16} />
