...
export default function FactoryDashboard() {
  ...
  function getUrgencyGradient(urgency: RestockAlert['urgency']) {
    const urgencyStyles: Record<string, { bg: string; border: string; glow: string }> = {
      critical: {
  ...
  if (loading) {
    return (
      <AdminLayout title="Factory Intelligence" subtitle="Production Monitoring">
        <div style={styles.loadingContent}>
          <div style={styles.loadingPulse} />
          <p style={styles.loadingContentText}>Initializing Factory Systems</p>
        </div>
        <style jsx global>{`
          @keyframes pulse {
  ...
  if (!authorized) {
    return (
      <AdminLayout title="Factory Intelligence" subtitle="Production Monitoring">
        <div style={styles.loadingContent}>
          <div style={styles.loadingPulse} />
          <p style={styles.loadingContentText}>Authenticating</p>
        </div>
        <style jsx global>{`
          @keyframes pulse {
            0%, 100% { opacity: 0.4; transform: scale(1); }
