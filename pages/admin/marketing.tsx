...
const kpiMetrics: KPIMetric[] = [
  { id: 'campaigns', label: 'Active Campaigns', value: '12', change: '3', changeType: 'up', icon: <Megaphone size={20} /> },
  { id: 'reach', label: 'Total Reach', value: '2.4M', change: '18%', changeType: 'up', icon: <Users size={20} /> },
  { id: 'engagement', label: 'Engagement Rate', value: '4.8%', change: '0.6%', changeType: 'up', icon: <TrendingUp size={20} /> },
  { id: 'conversion', label: 'Conversion Rate', value: '3.2%', change: '0.3%', changeType: 'up', icon: <Target size={20} /> },
  { id: 'roi', label: 'Marketing ROI', value: '324%', change: '28%', changeType: 'up', icon: <DollarSign size={20} /> },
];
...
const campaigns: Campaign[] = [
  ...
  { id: '4', name: 'Instagram Influencer Push', channel: 'Social', status: 'Active', budget: 20000, spend: 12400, impressions: 980000, clicks: 28900, conversions: 1456 },
  { id: '5', name: 'Email Newsletter - December', channel: 'Email', status: 'Completed', budget: 5000, spend: 4800, impressions: 125000, clicks: 8900, conversions: 567 },
  { id: '6', name: 'Facebook Retargeting', channel: 'Paid', status: 'Paused', budget: 12000, spend: 6200, impressions: 450000, clicks: 15800, conversions: 890 },
];

const channelData: ChannelData[] = [
  { channel: 'Email', impressions: 370000, clicks: 21700, conversions: 1459, ctr: 5.86, convRate: 6.72, color: '#8B5CF6' },
  { channel: 'Instagram', impressions: 1450000, clicks: 52400, conversions: 2680, ctr: 3.61, convRate: 5.11, color: '#EC4899' },
  { channel: 'TikTok', impressions: 890000, clicks: 38200, conversions: 1920, ctr: 4.29, convRate: 5.03, color: '#06B6D4' },
  { channel: 'Facebook', impressions: 720000, clicks: 24800, conversions: 1340, ctr: 3.44, convRate: 5.40, color: '#3B82F6' },
  { channel: 'Google Ads', impressions: 980000, clicks: 42100, conversions: 2450, ctr: 4.30, convRate: 5.82, color: NEON_GREEN },
];

const emailCampaigns: EmailCampaign[] = [
  { id: '1', subject: 'Holiday Flash Sale - 40% Off Everything!', sent: 85420, opened: 32640, clicked: 8920, converted: 567, date: 'Dec 8, 2025' },
  { id: '2', subject: 'Your Weekly Wellness Digest', sent: 124500, opened: 48960, clicked: 12340, converted: 892, date: 'Dec 6, 2025' },
  { id: '3', subject: 'New Flavors Just Dropped 🍓', sent: 98200, opened: 41580, clicked: 15670, converted: 1234, date: 'Dec 3, 2025' },
  { id: '4', subject: 'Member Exclusive: Early Access Sale', sent: 45600, opened: 22800, clicked: 6840, converted: 456, date: 'Nov 30, 2025' },
  { id: '5', subject: 'Black Friday Extended - Last Chance!', sent: 156000, opened: 68640, clicked: 24180, converted: 1890, date: 'Nov 27, 2025' },
];

const emailTrendData = [
  { week: 'W1', openRate: 38.2, clickRate: 10.4 },
  { week: 'W2', openRate: 41.5, clickRate: 12.8 },
  { week: 'W3', openRate: 39.8, clickRate: 11.2 },
  { week: 'W4', openRate: 44.2, clickRate: 15.5 },
];
...
const socialPlatforms: SocialPlatform[] = [
  ...
  { id: '3', name: 'Facebook', icon: <Facebook size={24} />, followers: '156K', engagement: '2.4%', recentPosts: 6, color: '#3B82F6' },
];

const topPosts: TopPost[] = [
  { id: '1', platform: 'Instagram', content: 'Morning smoothie ritual with our new Strawberry Peach blend 🍓', likes: 12400, comments: 892, shares: 2340, date: 'Dec 8, 2025' },
  { id: '2', platform: 'TikTok', content: 'POV: You finally found the perfect pre-workout smoothie', likes: 45600, comments: 3420, shares: 8900, date: 'Dec 7, 2025' },
  { id: '3', platform: 'Instagram', content: 'Behind the scenes at our California production facility 🏭', likes: 8900, comments: 567, shares: 1230, date: 'Dec 5, 2025' },
  { id: '4', platform: 'Facebook', content: 'Customer spotlight: How Sarah transformed her mornings with Drizzl', likes: 3420, comments: 234, shares: 890, date: 'Dec 4, 2025' },
];
    ...
    <div style={styles.kpiCard}>
      ...
      <div style={styles.kpiContent}>
        ...
        <div style={styles.kpiValueRow}>
          ...
          <span style={{ ...styles.kpiChange, color: metric.changeType === 'up' ? NEON_GREEN : '#FF6B6B' }}>
    ...
    <div style={styles.campaignCard}>
      ...
      <div style={styles.campaignBudget}>
        <div style={styles.budgetText}>
          <span>${campaign.spend.toLocaleString()} / ${campaign.budget.toLocaleString()}</span>
...
export default function MarketingPage() {
  return (
    <AdminLayout title="Marketing" subtitle="Campaigns, Content & Performance">
      {isDemoMode && (
        <div style={styles.demoBanner}>
          <AlertCircle size={16} />
          <span>Demo Mode: Viewing sample marketing data</span>
        </div>
      )}
      ...
      <section style={styles.section}>
        <h3 style={styles.sectionTitle}>Marketing Overview</h3>
      ...
      <div style={styles.twoColumnGrid}>
        ...
        <section style={styles.card}>
          ...
          <div style={styles.emailTable}>
            ...
            {emailCampaigns.slice(0, 4).map((email) => (
      ...
      <section style={styles.section}>
        ...
        <div style={{ ...styles.card, marginTop: 16 }}>
          <h4 style={styles.cardSubtitle}>Top Performing Posts</h4>
          <div style={styles.topPostsGrid}>
            {topPosts.map((post) => (
              <div key={post.id} style={styles.topPostCard}>
                <div style={styles.topPostHeader}>
                  <span style={styles.topPostPlatform}>{post.platform}</span>
                  <span style={styles.topPostDate}>{post.date}</span>
                </div>
      ...
      <div style={styles.twoColumnGrid}>
        <section style={styles.card}>
          ...
          <p style={styles.cardSubtext}>Upcoming content for the next 7 days</p>
