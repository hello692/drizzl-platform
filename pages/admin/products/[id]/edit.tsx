...
export default function EditProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const data = await res.json();
        setToast({ type: 'error', message: data.error || 'Failed to update product' });
      }
    } catch (err) {
  ...
  if (loading) {
    return (
      <CommandCenterLayout title="Edit Product">
  ...
  if (notFound) {
    return (
      <CommandCenterLayout title="Product Not Found">
        <div style={styles.notFoundContainer}>
          ...
          <Link href="/admin/products" style={styles.backToListBtn}>
            <ArrowLeft size={16} />
            Back to Products
          </Link>
        </div>
              ...
              <div style={styles.card}>
                ...
                <div style={styles.fieldGroup}>
                  ...
                  <input
                    ...
                    style={styles.input}
                  />
                  <span style={styles.fieldHint}>URL-friendly identifier</span>
                </div>
                <div style={styles.fieldGroup}>
          ...
          <div style={styles.modalOverlay} onClick={() => setShowDeleteModal(false)}>
            <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
              ...
              <p style={styles.modalText}>
                Are you sure you want to delete "<strong>{formData.name}</strong>"? This action
                cannot be undone.
              </p>
        ...
        {toast && (
          <div
            style={{
              ...styles.toast,
              backgroundColor:
                toast.type === 'success' ? 'rgba(0, 255, 133, 0.15)' : 'rgba(239, 68, 68, 0.15)',
