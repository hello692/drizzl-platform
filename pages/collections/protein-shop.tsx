...
const products = [
  { id: '40', name: 'Plant Protein Powder', price: 34.99, desc: 'Protein Powder' },
  { id: '41', name: 'Vanilla Protein Powder', price: 34.99, desc: 'Protein Powder' },
  { id: '42', name: 'Chocolate Protein Powder', price: 34.99, desc: 'Protein Powder' },
];

export default function ProteinShop() {
  return (
    <>
      <Navbar />
      <div style={{ minHeight: '60vh', padding: '60px 40px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <h1 style={{ marginBottom: '16px' }}>Protein Shop</h1>
          <p style={{ fontSize: '16px', color: '#666', marginBottom: '40px' }}>
            Premium organic protein powders to boost any smoothie or meal.
          </p>
