...
const products: Product[] = [
  { 
    ...
    rating: 4.5,
    badge: 'Best Seller',
    defaultImage: '/products/strawberry-peach/gallery-1.webp',
    hoverImage: '/products/strawberry-peach/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.7,
    badge: 'New',
    defaultImage: '/products/pink-piyata/gallery-1.webp',
    hoverImage: '/products/pink-piyata/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.8,
    badge: 'Best Seller',
    defaultImage: '/products/matcha/gallery-1.webp',
    hoverImage: '/products/matcha/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.6,
    badge: 'Best Seller',
    defaultImage: '/products/mocha/gallery-1.webp',
    hoverImage: '/products/mocha/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.7,
    badge: 'Best Seller',
    defaultImage: '/products/nutty-monkey/Nutty Monkey-1.webp',
    hoverImage: '/products/nutty-monkey/Nutty Monkey-2.webp',
  ...
  { 
    ...
    rating: 4.8,
    badge: 'New',
    defaultImage: '/products/mango-jackfruit/Mango Jackfruit-1.webp',
    hoverImage: '/products/mango-jackfruit/Mango Jackfruit-2.webp',
  ...
  { 
    ...
    rating: 4.8,
    badge: 'Best Seller',
    defaultImage: '/products/coffee-mushroom/gallery-1.webp',
    hoverImage: '/products/coffee-mushroom/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.8,
    badge: 'Best Seller',
    defaultImage: '/products/chocolate-berry/gallery-1.webp',
    hoverImage: '/products/chocolate-berry/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.7,
    badge: 'Best Seller',
    defaultImage: '/products/almond/gallery-1.webp',
    hoverImage: '/products/almond/gallery-2.webp',
  ...
  { 
    ...
    rating: 4.9,
    badge: 'Best Seller',
    defaultImage: '/products/acai/gallery-1.webp',
    hoverImage: '/products/acai/gallery-2.webp',
    ...
    <>
      ...
      <div className="smoothies-page" style={{ minHeight: '100vh', background: '#000000' }}>
        <div className="smoothies-hero-fullwidth">
          <img
            src="/images/smoothies-hero.webp"
            alt="Smoothies"
