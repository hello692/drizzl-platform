...
const videos = [
  { id: 1, title: 'Welcome to Drizzl Partnership', duration: '5:00', category: 'getting-started', views: 2450, rating: 4.9, watched: true, thumbnail: '/lifestyle/DSC09048-1.jpg' },
  { id: 2, title: 'Setting Up Your Account', duration: '3:00', category: 'getting-started', views: 2180, rating: 4.8, watched: true, thumbnail: '/lifestyle/DSC09063.jpg' },
  { id: 3, title: 'Your First Order - Step by Step', duration: '8:00', category: 'getting-started', views: 1950, rating: 4.9, watched: true, thumbnail: '/lifestyle/DSC09073-1-2.jpg' },
  { id: 4, title: 'Complete Product Overview', duration: '15:00', category: 'product-knowledge', views: 1820, rating: 4.7, watched: true, thumbnail: '/lifestyle/DSC08472.jpg' },
  { id: 5, title: 'Optimal Freezer Layout', duration: '7:00', category: 'merchandising', views: 1650, rating: 4.8, watched: true, thumbnail: '/lifestyle/DSC08818.jpg' },
  { id: 6, title: 'Selling Health Benefits', duration: '8:00', category: 'sales', views: 1520, rating: 4.6, watched: false, thumbnail: '/lifestyle/DSC08825.jpg' },
  { id: 7, title: 'Smoothie Flavor Profiles Deep Dive', duration: '12:00', category: 'product-knowledge', views: 1480, rating: 4.8, watched: false, thumbnail: '/lifestyle/DSC08827.jpg' },
  { id: 8, title: 'Creating Eye-Catching Displays', duration: '10:00', category: 'merchandising', views: 1350, rating: 4.7, watched: false, thumbnail: '/lifestyle/DSC08836.jpg' },
  { id: 9, title: 'Upselling Strategies That Work', duration: '9:00', category: 'sales', views: 1280, rating: 4.5, watched: false, thumbnail: '/lifestyle/DSC08837.jpg' },
  { id: 10, title: 'Social Media Marketing 101', duration: '11:00', category: 'marketing', views: 1150, rating: 4.6, watched: false, thumbnail: '/lifestyle/DSC09091.jpg' },
  { id: 11, title: 'Inventory Management Best Practices', duration: '14:00', category: 'operations', views: 980, rating: 4.7, watched: false, thumbnail: '/lifestyle/DSC09092.jpg' },
  { id: 12, title: 'Handling Customer Questions', duration: '6:00', category: 'customer-service', views: 920, rating: 4.8, watched: false, thumbnail: '/lifestyle/DSC09108-2.jpg' },
  { id: 13, title: 'Common Issues & Solutions', duration: '8:00', category: 'troubleshooting', views: 850, rating: 4.6, watched: false, thumbnail: '/lifestyle/DSC09118.jpg' },
  { id: 14, title: 'Local Marketing Strategies', duration: '10:00', category: 'marketing', views: 780, rating: 4.5, watched: false, thumbnail: '/lifestyle/DSC09230.jpg' },
  { id: 15, title: 'Temperature & Storage Guidelines', duration: '5:00', category: 'operations', views: 720, rating: 4.9, watched: false, thumbnail: '/lifestyle/DSC09242.jpg' },
  { id: 16, title: 'Building Customer Loyalty', duration: '7:00', category: 'customer-service', views: 680, rating: 4.7, watched: false, thumbnail: '/lifestyle/DSC09300.jpg' },
  { id: 17, title: 'Seasonal Promotion Ideas', duration: '9:00', category: 'marketing', views: 620, rating: 4.6, watched: false, thumbnail: '/lifestyle/DSC09302.jpg' },
  { id: 18, title: 'Delivery & Receiving Process', duration: '6:00', category: 'operations', views: 580, rating: 4.8, watched: false, thumbnail: '/lifestyle/beach.jpg' },
];
