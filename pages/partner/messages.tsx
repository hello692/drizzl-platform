...
const mockConversations: Conversation[] = [
  {
    ...
    name: 'Sarah Johnson',
    role: 'Sales Rep',
    lastMessage: 'Just checking in on your last order...',
    timestamp: 'Today',
    unreadCount: 2,
    isOnline: true,
  },
  ...
  },
  {
    ...
    name: 'Mike Thompson',
    role: 'Sales Rep',
    lastMessage: 'Looking forward to our quarterly review',
    timestamp: 'Dec 5',
    unreadCount: 0,
    isOnline: false,
  },
  ...
  '1': [
    {
      ...
      content: "Hey! Just wanted to check in on your last order. Everything arrive okay?",
    ...
    },
    {
      ...
      senderId: 'me',
      senderName: 'You',
      content: "Yes! Everything was perfect. We're already seeing great sales on the Green Detox.",
    ...
    },
    {
      ...
      senderId: 'sarah',
      senderName: 'Sarah Johnson',
      content: "That's awesome! 🎉 Ready to place another order?",
  ...
  '2': [
    {
      ...
      content: "Hello! We've received your inquiry about order tracking.",
    ...
    },
    {
      ...
      senderId: 'me',
      senderName: 'You',
      content: "Thanks! I was wondering about the status of my recent delivery.",
    ...
    },
    {
      ...
      senderId: 'support',
      senderName: 'Support Team',
      content: "Your ticket #1234 has been resolved. The package was delivered successfully. Is there anything else we can help with?",
  ...
  '3': [
    {
      ...
      content: "Hi there! Looking forward to our quarterly review next week.",
      timestamp: 'Dec 5 11:00 AM',
      isOwn: false,
      status: 'read',
    },
    {
      ...
      senderId: 'me',
      senderName: 'You',
      content: "Sounds great! I'll prepare the sales numbers.",
      timestamp: 'Dec 5 11:30 AM',
      isOwn: true,
      status: 'delivered',
    },
  ],
...
export default function PartnerMessages() {
  ...
  return (
    <PartnerLayout title="Messages" partnerName={partnerName}>
                  ...
                  >
                    ...
                    <div style={styles.conversationContent}>
                      ...
                      <div style={styles.conversationMeta}>
                        <span style={{
                          ...styles.roleBadge,
                          backgroundColor: conversation.role === 'Sales Rep'
                            ? 'rgba(139, 92, 246, 0.15)'
                            : 'rgba(59, 130, 246, 0.15)',
                          color: conversation.role === 'Sales Rep' ? '#A78BFA' : '#60A5FA',
                        }}>
                          {conversation.role}
                        </span>
                      </div>
                ...
                <div style={styles.participantInfo}>
                  ...
                  <div>
                    ...
                    <div style={styles.participantStatus}>
                      <span style={{
                        ...styles.roleBadge,
                        backgroundColor: selectedConversation.role === 'Sales Rep'
                          ? 'rgba(139, 92, 246, 0.15)'
                          : 'rgba(59, 130, 246, 0.15)',
                        color: selectedConversation.role === 'Sales Rep' ? '#A78BFA' : '#60A5FA',
                      }}>
