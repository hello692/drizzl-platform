...
const smoothies: { [key: string]: any } = {
  ...
  '2': {
    ...
    rating: 4.5,
    badge: 'NEW',
    image: '/products/strawberry-banana-protein/transparent-glass-1.png',
    hoverImage: '/products/strawberry-banana-protein/transparent-glass-2.png',
    images: [
      '/products/strawberry-banana-protein/transparent-glass-1.png',
      '/products/strawberry-banana-protein/transparent-glass-2.png',
      '/products/strawberry-banana-protein/transparent-glass-3.png',
