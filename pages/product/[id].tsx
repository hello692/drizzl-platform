...
const smoothies: { [key: string]: any } = {
  ...
  '15': {
    ...
    keyIngredients: [
      { name: 'Cacao (Nibs & Powder)', description: 'The chocolate goddess, rich in flavonoids to boost your mood and focus.' },
      { name: 'Rolled Oats', description: 'The slow-burn energy hero, keeping you steady and strong.' },
      { name: 'Dates', description: 'Sweet, fiber-packed, and full of minerals—like a hug from nature.' },
      { name: 'Banana', description: 'Creamy texture with potassium to keep you balanced and glowing.' },
      { name: 'Chia Seeds', description: 'Protein and omega-3s to fuel your body and keep you satisfied.' },
      { name: 'Maca Extract', description: "The jungle's secret weapon for energy and resilience." },
    ],
    prepSteps: [
