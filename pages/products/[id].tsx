...
const PRODUCT_DATA: Record<string, ProductData> = {
  ...
  '15': {
    ...
    keyIngredients: [
      { name: 'Cacao (Nibs & Powder)', benefit: 'The chocolate goddess, rich in flavonoids to boost your mood and focus.', image: '/ingredients/cacao.png' },
      { name: 'Rolled Oats', benefit: 'The slow-burn energy hero, keeping you steady and strong.', image: '/ingredients/oats.png' },
      { name: 'Dates', benefit: 'Sweet, fiber-packed, and full of minerals—like a hug from nature.', image: '/ingredients/dates.png' },
      { name: 'Banana', benefit: 'Creamy texture with potassium to keep you balanced and glowing.', image: '/ingredients/banana.png' },
      { name: 'Chia Seeds', benefit: 'Protein and omega-3s to fuel your body and keep you satisfied.', image: '/ingredients/chia.png' },
      { name: 'Maca Extract', benefit: "The jungle's secret weapon for energy and resilience.", image: '/ingredients/maca.png' },
    ],
