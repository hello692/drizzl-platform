...
const PRODUCT_DATA: Record<string, ProductData> = {
  ...
  '14': {
    ...
    lifestyleGallery: [
      ...
      { src: '/lifestyle/DSC09230.jpg', alt: 'Coffee Mushroom lifestyle 4' },
      { src: '/lifestyle/DSC09242.jpg', alt: 'Coffee Mushroom lifestyle 5' },
      { src: '/lifestyle/change-the-nail-polish-color-to-white--keep-everyt (4).jpg', alt: 'Coffee Mushroom lifestyle 6' },
      { src: '/lifestyle/Copy of 890A5666_out1.jpg', alt: 'Coffee Mushroom lifestyle 7' },
      { src: '/lifestyle/Copy of 890A5679_out1.jpg', alt: 'Coffee Mushroom lifestyle 8' },
      { src: '/lifestyle/Copy of 890A5705_out1.jpg', alt: 'Coffee Mushroom lifestyle 9' },
      { src: '/lifestyle/Copy of 890A5711_out1.jpg', alt: 'Coffee Mushroom lifestyle 10' },
      { src: '/lifestyle/Copy of 890A5763_out1.jpg', alt: 'Coffee Mushroom lifestyle 11' },
    ],
