...
const PRODUCT_DATA: Record<string, ProductData> = {
  ...
  '17': {
    ...
    description: "It's midnight in the Amazon. The moon glows overhead. The jungle hums with life. Somewhere deep beneath the canopy, a single acai berry drops into a pool of coconut water. BOOM — flavor is born. This smoothie is pure rainforest energy. Wild-harvested acai berries, bold guarana, and tropical fruits collide in a blend so vibrant it practically swings on vines. It's bold. It's smooth. It's like drinking a tropical rainstorm under a jungle moon.",
    ingredients: 'Organic acai berries, organic blueberries, organic banana, organic strawberries, organic guarana, organic hemp hearts, organic coconut water. Caffeine: Naturally occurring from guarana.',
    nutrition: {
      servingSize: '1 cup',
      servingsPerContainer: 1,
      calories: 170,
      facts: [
        { label: 'Total Fat', value: '4g', dv: 5 },
        { label: 'Saturated Fat', value: '1g', dv: 5, indent: true },
        { label: 'Trans Fat', value: '0g', dv: null, indent: true },
        { label: 'Cholesterol', value: '0mg', dv: 0 },
        { label: 'Sodium', value: '10mg', dv: 0 },
        { label: 'Total Carbohydrate', value: '30g', dv: 11 },
      ...
      highlights: [
        ...
        { label: 'Protein', value: '3g', percent: 6, color: '#8b5cf6' },
        { label: 'Carbs', value: '30g', percent: 11, color: '#f59e0b' },
      ]
    },
    keyIngredients: [
      { name: 'Acai', benefit: 'One of the most antioxidant-rich fruits on earth, supporting cellular health and vitality.', image: '/ingredients/acai.png' },
      { name: 'Blueberries', benefit: 'Brain-boosting antioxidants that support cognitive function.', image: '/ingredients/blueberry.png' },
      { name: 'Guarana', benefit: 'Naturally sourced caffeine for sustained energy without the crash.', image: '/ingredients/guarana.png' },
      { name: 'Banana', benefit: 'Creamy texture and natural sweetness with potassium for balance and recovery.', image: '/ingredients/banana.png' },
      { name: 'Hemp Hearts', benefit: 'Complete plant protein with omega fatty acids for heart health.', image: '/ingredients/hemp.png' },
      { name: 'Coconut Water', benefit: 'Natural hydration packed with electrolytes for refreshment and recovery.', image: '/ingredients/coconutwater.png' },
    ],
    badges: ['Gluten-Free', 'Dairy-Free', 'Plant-Based', 'No Added Sugar', 'Superfood', 'Contains Caffeine'],
  },
  '12': {
    id: '12',
    name: 'Nutty Monkey',
