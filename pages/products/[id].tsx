...
const PRODUCT_DATA: Record<string, ProductData> = {
  ...
  '15': {
    ...
    price: 8.99,
    image: '/products/chocolate-berry/Chocolate-Berry-TG-1.jpg',
    shortDescription: 'Decadent & nutritious',
    tagline: 'indulgence meets wellness',
    rating: { average: 4.8, count: 2891 },
    gallery: [
      '/products/chocolate-berry/Chocolate-Berry-TG-1.jpg',
      '/products/chocolate-berry/Chocolate-Berry-TG-2.jpg',
      '/products/chocolate-berry/Chocolate-Berry-TG-3.jpg',
      '/products/chocolate-berry/DSC07702.jpg',
      '/products/chocolate-berry/DSC07714.jpg',
      '/products/chocolate-berry/DSC07720-2.jpg',
      '/products/chocolate-berry/DSC09073-1-2Chocolate-berry.jpg',
    ],
    lifestyleGallery: [
      { src: '/lifestyle/DSC09073-1-2Chocolate-berry.jpg', alt: 'Chocolate Berry lifestyle 1' },
      { src: '/lifestyle/DSC08472.jpg', alt: 'Chocolate Berry lifestyle 2' },
      { src: '/lifestyle/DSC09300.jpg', alt: 'Chocolate Berry lifestyle 3' },
      { src: '/lifestyle/DSC09302.jpg', alt: 'Chocolate Berry lifestyle 4' },
    ],
