...
const PRODUCT_DATA: Record<string, ProductData> = {
  '1': {
    ...
    gallery: [
      ...
      '/products/strawberry-peach/gallery-4.jpg',
      '/products/strawberry-peach/gallery-5.jpg',
      '/products/strawberry-peach/gallery-6.jpg',
      '/products/strawberry-peach/gallery-7.jpg',
      '/products/strawberry-peach/gallery-8.jpg',
