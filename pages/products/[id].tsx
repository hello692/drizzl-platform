...
const PRODUCT_DATA: Record<string, ProductData> = {
  '1': {
    ...
    price: 8.49,
    image: '/products/strawberry-peach/gallery-1.webp',
    shortDescription: 'Creamy strawberry bliss',
    tagline: 'a scoop of strawberry-banana sorbet',
    rating: { average: 4.5, count: 4619 },
    gallery: [
      '/products/strawberry-peach/gallery-1.webp',
      '/products/strawberry-peach/gallery-2.webp',
      '/products/strawberry-peach/gallery-3.webp',
      '/products/strawberry-peach/gallery-4.webp',
      '/products/strawberry-peach/gallery-5.webp',
      '/products/strawberry-peach/gallery-6.webp',
      '/products/strawberry-peach/gallery-7.webp',
    ],
    ...
    keyIngredients: [
      { name: 'Strawberry', benefit: 'One cup of strawberries is high in antioxidant vitamin C and provides a good source of fiber, copper and folate.', image: '/ingredients/strawberry.webp' },
      { name: 'Banana', benefit: 'One large banana is a good source of potassium and vitamin C.', image: '/ingredients/banana.webp' },
      { name: 'Peach', benefit: 'Peaches are rich in vitamins A and C, supporting immune health and glowing skin.', image: '/ingredients/peach.webp' },
      { name: 'Raspberry', benefit: 'Raspberries are high in fiber and antioxidants for gut and heart health.', image: '/ingredients/raspberry.webp' },
      { name: 'Oats', benefit: 'Oats provide heart-healthy whole grains for sustained energy throughout the day.', image: '/ingredients/oats.webp' },
      { name: 'Goji Berry', benefit: 'Goji berries are a superfood rich in amino acids and beta-carotene.', image: '/ingredients/goji.webp' },
    ],
  ...
  '9': {
    ...
    name: 'Pink Piyata',
    price: 8.99,
    image: '/products/pink-piyata/gallery-1.webp',
    shortDescription: 'Tropical dragon fruit',
    tagline: 'a tropical paradise in every sip',
    rating: { average: 4.8, count: 3842 },
    gallery: [
      '/products/pink-piyata/gallery-1.webp',
      '/products/pink-piyata/gallery-2.webp',
      '/products/pink-piyata/gallery-3.webp',
      '/products/pink-piyata/gallery-4.webp',
      '/products/pink-piyata/gallery-5.webp',
      '/products/pink-piyata/gallery-6.webp',
      '/products/pink-piyata/gallery-7.webp',
      '/products/pink-piyata/gallery-8.webp',
      '/products/pink-piyata/gallery-9.webp',
      '/products/pink-piyata/gallery-10.webp',
      '/products/pink-piyata/gallery-11.webp',
      '/products/pink-piyata/gallery-12.webp',
      '/products/pink-piyata/gallery-13.webp',
      '/products/pink-piyata/gallery-14.webp',
      '/products/pink-piyata/gallery-15.webp',
      '/products/pink-piyata/gallery-16.webp',
      '/products/pink-piyata/gallery-17.webp',
    ],
    lifestyleGallery: [
      { src: '/products/pink-piyata/lifestyle-1.webp', alt: 'Pink Piyata lifestyle 1' },
      { src: '/products/pink-piyata/lifestyle-2.webp', alt: 'Pink Piyata lifestyle 2' },
      { src: '/products/pink-piyata/lifestyle-3.webp', alt: 'Pink Piyata lifestyle 3' },
      { src: '/products/pink-piyata/lifestyle-4.webp', alt: 'Pink Piyata lifestyle 4' },
      { src: '/products/pink-piyata/lifestyle-5.webp', alt: 'Pink Piyata lifestyle 5' },
    ],
    ...
    keyIngredients: [
      { name: 'Dragon Fruit', benefit: 'Rich in antioxidants and supports healthy digestion with prebiotics.', image: '/ingredients/dragonfruit.webp' },
      { name: 'Pineapple', benefit: 'Contains bromelain for digestive health and vitamin C for immunity.', image: '/ingredients/pineapple.webp' },
      { name: 'Coconut', benefit: 'Natural electrolytes for hydration and healthy medium-chain fats.', image: '/ingredients/coconut.webp' },
      { name: 'Mango', benefit: 'High in vitamin C and beta-carotene for skin and eye health.', image: '/ingredients/mango.webp' },
      { name: 'Banana', benefit: 'Natural energy boost with potassium for muscle recovery.', image: '/ingredients/banana.webp' },
      { name: 'Chia Seeds', benefit: 'Omega-3 fatty acids and plant-based protein for sustained energy.', image: '/ingredients/chia.webp' },
    ],
    badges: ['Gluten-Free', 'Dairy-Free', 'Made from Plants', 'No Sugar Added'],
  },
  '10': {
    ...
    name: 'Matcha',
    price: 9.49,
    image: '/products/matcha/gallery-1.webp',
    shortDescription: 'Zen in a cup',
    tagline: 'calm focus meets creamy indulgence',
    rating: { average: 4.7, count: 2156 },
    gallery: [
      '/products/matcha/gallery-1.webp',
      '/products/matcha/gallery-2.webp',
      '/products/matcha/gallery-3.webp',
      '/products/matcha/gallery-4.webp',
      '/products/matcha/gallery-5.webp',
      '/products/matcha/gallery-6.webp',
      '/products/matcha/gallery-7.webp',
      '/products/matcha/gallery-8.webp',
      '/products/matcha/gallery-9.webp',
      '/products/matcha/gallery-10.webp',
      '/products/matcha/gallery-11.webp',
      '/products/matcha/gallery-12.webp',
      '/products/matcha/gallery-13.webp',
      '/products/matcha/gallery-14.webp',
      '/products/matcha/gallery-15.webp',
    ],
    lifestyleGallery: [
      { src: '/products/matcha/lifestyle-1.webp', alt: 'Matcha lifestyle 1' },
      { src: '/products/matcha/lifestyle-2.webp', alt: 'Matcha lifestyle 2' },
      { src: '/products/matcha/lifestyle-3.webp', alt: 'Matcha lifestyle 3' },
      { src: '/products/matcha/lifestyle-4.webp', alt: 'Matcha lifestyle 4' },
      { src: '/products/matcha/lifestyle-5.webp', alt: 'Matcha lifestyle 5' },
    ],
    ...
    keyIngredients: [
      { name: 'Matcha', benefit: 'L-theanine for calm, focused energy without the jitters.', image: '/ingredients/matcha.webp' },
      { name: 'Banana', benefit: 'Natural sweetness and creaminess with potassium.', image: '/ingredients/banana.webp' },
      { name: 'Almond Butter', benefit: 'Healthy fats and protein for sustained satiety.', image: '/ingredients/almond.webp' },
      { name: 'Spinach', benefit: 'Iron and vitamins for energy without changing the taste.', image: '/ingredients/spinach.webp' },
      { name: 'Hemp Seeds', benefit: 'Complete plant protein source with all essential amino acids.', image: '/ingredients/hemp.webp' },
      { name: 'Vanilla', benefit: 'Natural mood enhancer with calming aromatherapy benefits.', image: '/ingredients/vanilla.webp' },
    ],
  ...
  '11': {
    ...
    name: 'Mocha',
    price: 9.49,
    image: '/products/mocha/gallery-1.webp',
    shortDescription: 'Chocolate coffee bliss',
    tagline: 'rich chocolate meets smooth espresso',
    rating: { average: 4.8, count: 2847 },
    gallery: [
      '/products/mocha/gallery-1.webp',
      '/products/mocha/gallery-2.webp',
      '/products/mocha/gallery-3.webp',
      '/products/mocha/gallery-4.webp',
      '/products/mocha/gallery-5.webp',
      '/products/mocha/gallery-6.webp',
      '/products/mocha/gallery-7.webp',
      '/products/mocha/gallery-8.webp',
      '/products/mocha/gallery-9.webp',
      '/products/mocha/gallery-10.webp',
      '/products/mocha/gallery-11.webp',
      '/products/mocha/gallery-12.webp',
      '/products/mocha/gallery-13.webp',
      '/products/mocha/gallery-14.webp',
    ],
    lifestyleGallery: [
      { src: '/products/mocha/lifestyle-1.webp', alt: 'Mocha lifestyle 1' },
      { src: '/products/mocha/lifestyle-2.webp', alt: 'Mocha lifestyle 2' },
      { src: '/products/mocha/lifestyle-3.webp', alt: 'Mocha lifestyle 3' },
      { src: '/products/mocha/lifestyle-4.webp', alt: 'Mocha lifestyle 4' },
    ],
    ...
    keyIngredients: [
      { name: 'Cold Brew', benefit: 'Smooth, less acidic caffeine for steady, sustained energy.', image: '/ingredients/coffee.webp' },
      { name: 'Cacao', benefit: 'Rich in antioxidants and natural mood-boosting compounds.', image: '/ingredients/cacao.webp' },
      { name: 'Banana', benefit: 'Natural sweetness with potassium for muscle recovery.', image: '/ingredients/banana.webp' },
      { name: 'Almond Butter', benefit: 'Healthy fats and protein for lasting satiety.', image: '/ingredients/almond.webp' },
      { name: 'Dates', benefit: 'Natural sweetener packed with fiber and minerals.', image: '/ingredients/dates.webp' },
      { name: 'Oat Milk', benefit: 'Creamy texture with heart-healthy beta-glucan fiber.', image: '/ingredients/oatmilk.webp' },
    ],
    badges: ['Gluten-Free', 'Dairy-Free', 'Made from Plants', 'Caffeine'],
  },
  '14': {
    ...
    price: 9.99,
    image: '/products/mushroom-coffee/Coffr Mushroom-TG-1.webp',
    shortDescription: 'Adaptogenic energy',
    tagline: 'your morning coffee evolved',
    rating: { average: 4.6, count: 1893 },
    gallery: [
      '/products/mushroom-coffee/Coffr Mushroom-TG-1.webp',
      '/products/mushroom-coffee/Coffr Mushroom-TG-2.webp',
      '/products/mushroom-coffee/Coffr Mushroom-TG-3.webp',
      '/products/mushroom-coffee/DSC07772.webp',
      '/products/mushroom-coffee/DSC07777-2.webp',
      '/products/mushroom-coffee/DSC07787.webp',
    ],
    lifestyleGallery: [
      { src: '/products/coffee-mushroom/lifestyle-1.webp', alt: 'Coffee Mushroom lifestyle 1' },
      { src: '/products/coffee-mushroom/lifestyle-2.webp', alt: 'Coffee Mushroom lifestyle 2' },
      { src: '/products/coffee-mushroom/lifestyle-3.webp', alt: 'Coffee Mushroom lifestyle 3' },
    ],
    ...
    keyIngredients: [
      { name: 'Cold Brew', benefit: 'Smooth, less acidic caffeine boost for steady energy.', image: '/ingredients/coffee.webp' },
      { name: 'Lions Mane', benefit: 'Supports focus, memory, and cognitive function.', image: '/ingredients/lionsmane.webp' },
      { name: 'Chaga', benefit: 'Powerful immune system support and antioxidants.', image: '/ingredients/chaga.webp' },
      { name: 'Reishi', benefit: 'Adaptogenic mushroom for stress relief and calm.', image: '/ingredients/reishi.webp' },
      { name: 'Oat Milk', benefit: 'Creamy texture with heart-healthy fiber.', image: '/ingredients/oatmilk.webp' },
      { name: 'Cacao', benefit: 'Mood-boosting antioxidants and natural magnesium.', image: '/ingredients/cacao.webp' },
    ],
  ...
  '15': {
    ...
    price: 8.99,
    image: '/products/chocolate-berry/Chocolate Berry-1.webp',
    shortDescription: 'Decadent & nutritious',
    tagline: 'indulgence meets wellness',
    rating: { average: 4.8, count: 2891 },
    gallery: [
      '/products/chocolate-berry/Chocolate Berry-1.webp',
      '/products/chocolate-berry/Chocolate Berry-2.webp',
      '/products/chocolate-berry/Chocolate Berry-3.webp',
      '/products/chocolate-berry/Chocolate Berry-4.webp',
      '/products/chocolate-berry/Chocolate Berry-5.webp',
      '/products/chocolate-berry/Chocolate Berry-6.webp',
    ],
    lifestyleGallery: [
      { src: '/products/chocolate-berry/lifestyle-1.webp', alt: 'Chocolate Berry lifestyle 1' },
      { src: '/products/chocolate-berry/lifestyle-2.webp', alt: 'Chocolate Berry lifestyle 2' },
      { src: '/products/chocolate-berry/lifestyle-3.webp', alt: 'Chocolate Berry lifestyle 3' },
    ],
    ...
    keyIngredients: [
      { name: 'Cacao', benefit: 'Rich in flavonoids and mood-boosting compounds for mental wellness.', image: '/ingredients/cacao.webp' },
      { name: 'Raspberries', benefit: 'Fiber-rich berries with powerful antioxidants for cellular health.', image: '/ingredients/raspberry.webp' },
      { name: 'Strawberries', benefit: 'Vitamin C powerhouse for immune support and skin health.', image: '/ingredients/strawberry.webp' },
      { name: 'Blueberries', benefit: 'Brain-boosting antioxidants for cognitive function.', image: '/ingredients/blueberry.webp' },
      { name: 'Almond Butter', benefit: 'Healthy fats and protein for sustained energy and satiety.', image: '/ingredients/almondbutter.webp' },
      { name: 'Banana', benefit: 'Natural sweetness and potassium for muscle recovery.', image: '/ingredients/banana.webp' },
    ],
  ...
  '16': {
    ...
    name: 'Almond',
    price: 8.99,
    image: '/products/almond/Almond-1.webp',
    shortDescription: 'Creamy & nutty',
    tagline: 'pure almond bliss',
    rating: { average: 4.7, count: 1876 },
    gallery: [
      '/products/almond/Almond-1.webp',
      '/products/almond/Almond-2.webp',
      '/products/almond/Almond-3.webp',
      '/products/almond/Almond-4.webp',
      '/products/almond/Almond-5.webp',
      '/products/almond/Almond-6.webp',
    ],
    lifestyleGallery: [
      { src: '/products/almond/lifestyle-1.webp', alt: 'Almond lifestyle 1' },
      { src: '/products/almond/lifestyle-2.webp', alt: 'Almond lifestyle 2' },
      { src: '/products/almond/lifestyle-3.webp', alt: 'Almond lifestyle 3' },
    ],
    ...
    keyIngredients: [
      { name: 'Almond Butter', benefit: 'Healthy fats and protein for sustained energy and heart health.', image: '/ingredients/almondbutter.webp' },
      { name: 'Almond Milk', benefit: 'Light and creamy base with vitamin E for skin health.', image: '/ingredients/almondmilk.webp' },
      { name: 'Banana', benefit: 'Natural sweetness and potassium for muscle recovery.', image: '/ingredients/banana.webp' },
      { name: 'Honey', benefit: 'Natural sweetener with antibacterial properties.', image: '/ingredients/honey.webp' },
      { name: 'Cinnamon', benefit: 'Warming spice that helps regulate blood sugar.', image: '/ingredients/cinnamon.webp' },
      { name: 'Dates', benefit: 'Natural sweetness with fiber and essential minerals.', image: '/ingredients/dates.webp' },
    ],
  ...
  '17': {
    ...
    name: 'Acai',
    price: 9.49,
    image: '/products/acai/Acai-1.webp',
    shortDescription: 'Amazonian superfruit',
    tagline: 'the Amazon in a cup',
    rating: { average: 4.9, count: 5234 },
    gallery: [
      '/products/acai/Acai-1.webp',
      '/products/acai/Acai-2.webp',
      '/products/acai/Acai-3.webp',
      '/products/acai/Acai-4.webp',
      '/products/acai/Acai-5.webp',
      '/products/acai/Acai-6.webp',
    ],
    lifestyleGallery: [
      { src: '/products/acai/lifestyle-1.webp', alt: 'Acai lifestyle 1' },
      { src: '/products/acai/lifestyle-2.webp', alt: 'Acai lifestyle 2' },
      { src: '/products/acai/lifestyle-3.webp', alt: 'Acai lifestyle 3' },
    ],
    ...
    keyIngredients: [
      { name: 'Acai', benefit: 'One of the most antioxidant-rich fruits on earth for cellular health.', image: '/ingredients/acai.webp' },
      { name: 'Blueberries', benefit: 'Brain-boosting antioxidants for cognitive function.', image: '/ingredients/blueberry.webp' },
      { name: 'Guarana', benefit: 'Natural, sustained energy boost without the crash.', image: '/ingredients/guarana.webp' },
      { name: 'Banana', benefit: 'Creamy texture and natural sweetness with potassium.', image: '/ingredients/banana.webp' },
      { name: 'Hemp Hearts', benefit: 'Complete protein and omega fatty acids for heart health.', image: '/ingredients/hemp.webp' },
      { name: 'Coconut Water', benefit: 'Natural hydration and electrolytes for recovery.', image: '/ingredients/coconutwater.webp' },
    ],
  ...
  '12': {
    ...
    name: 'Nutty Monkey',
    price: 8.99,
    image: '/products/nutty-monkey/Nutty Monkey-1.webp',
    shortDescription: 'Creamy peanut butter',
    tagline: 'the classic combo perfected',
    rating: { average: 4.8, count: 3567 },
    gallery: [
      '/products/nutty-monkey/Nutty Monkey-1.webp',
      '/products/nutty-monkey/Nutty Monkey-2.webp',
      '/products/nutty-monkey/Nutty Monkey-3.webp',
      '/products/nutty-monkey/Nutty Monkey-4.webp',
      '/products/nutty-monkey/Nutty Monkey-5.webp',
      '/products/nutty-monkey/Nutty Monkey-6.webp',
    ],
    lifestyleGallery: [
    ...
    keyIngredients: [
      { name: 'Peanut Butter', benefit: 'Rich in protein and healthy fats for lasting satiety.', image: '/ingredients/peanutbutter.webp' },
      { name: 'Banana', benefit: 'Natural sweetness and potassium for muscle recovery.', image: '/ingredients/banana.webp' },
      { name: 'Cacao', benefit: 'Mood-boosting antioxidants and natural magnesium.', image: '/ingredients/cacao.webp' },
      { name: 'Honey', benefit: 'Natural sweetener with antibacterial properties.', image: '/ingredients/honey.webp' },
      { name: 'Oat Milk', benefit: 'Creamy texture with heart-healthy beta-glucan fiber.', image: '/ingredients/oatmilk.webp' },
      { name: 'Flax Seeds', benefit: 'Omega-3 fatty acids for brain and heart health.', image: '/ingredients/flax.webp' },
    ],
    badges: ['Gluten-Free', 'Dairy-Free', 'Made from Plants', 'High Protein'],
  },
  '13': {
    ...
    price: 8.99,
    image: '/products/mango-jackfruit/Mango Jackfruit-1.webp',
    shortDescription: 'Tropical paradise',
    tagline: 'sunshine in every sip',
    rating: { average: 4.8, count: 2134 },
    gallery: [
      '/products/mango-jackfruit/Mango Jackfruit-1.webp',
      '/products/mango-jackfruit/Mango Jackfruit-2.webp',
      '/products/mango-jackfruit/Mango Jackfruit-3.webp',
      '/products/mango-jackfruit/Mango Jackfruit-4.webp',
      '/products/mango-jackfruit/Mango Jackfruit-5.webp',
      '/products/mango-jackfruit/Mango Jackfruit-6.webp',
    ],
    lifestyleGallery: [
    ...
    keyIngredients: [
      { name: 'Mango', benefit: 'Rich in vitamin C and beta-carotene for immune support and glowing skin.', image: '/ingredients/mango.webp' },
      { name: 'Jackfruit', benefit: 'Natural sweetness with fiber and antioxidants for digestive health.', image: '/ingredients/jackfruit.webp' },
      { name: 'Coconut Milk', benefit: 'Creamy texture with MCTs for sustained energy and brain function.', image: '/ingredients/coconutmilk.webp' },
      { name: 'Turmeric', benefit: 'Powerful anti-inflammatory curcumin for joint and immune health.', image: '/ingredients/turmeric.webp' },
      { name: 'Ginger', benefit: 'Aids digestion and provides natural anti-nausea benefits.', image: '/ingredients/ginger.webp' },
      { name: 'Coconut Water', benefit: 'Natural hydration and electrolytes for recovery.', image: '/ingredients/coconutwater.webp' },
    ],
...
const POPULAR_SMOOTHIES = [
  ...
  { id: '17', name: 'Acai', price: 9.49, image: '/products/acai/Acai-1.webp', hoverImage: '/products/acai/Acai-2.webp', badge: 'BEST SELLER', rating: 4.9, reviews: 487 },
  ...
  { id: '16', name: 'Almond', price: 8.99, image: '/products/almond/Almond-1.webp', hoverImage: '/products/almond/Almond-2.webp', badge: 'BEST SELLER', rating: 4.7, reviews: 187 },
];
